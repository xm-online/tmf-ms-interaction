package com.icthh.xm.tmf.ms.interaction.service;
...
import com.icthh.xm.tmf.ms.interaction.lep.LepContext;
...
@SpringBootTest(classes = {InteractionApp.class, LepContextCastIntTest.TestLepConfiguration.class})
public class LepContextCastIntTest {
    ...
    public void testLepContextCast() {
        String prefix = "/config/tenants/TEST_TENANT/interaction/lep/test/";
        String key = prefix + "ScriptWithAround$$around.groovy";
        String body = "import com.icthh.xm.tmf.ms.interaction.lep.LepContext;\nLepContext context = lepContext\nreturn ['context':context]";
