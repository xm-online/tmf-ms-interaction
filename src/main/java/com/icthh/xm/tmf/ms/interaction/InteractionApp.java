...
public class InteractionApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(InteractionApp.class);

    private final Environment env;

    public InteractionApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(InteractionApp.class);
