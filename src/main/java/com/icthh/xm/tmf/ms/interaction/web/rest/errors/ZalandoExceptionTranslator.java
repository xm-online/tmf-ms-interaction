...
import com.icthh.xm.tmf.ms.interaction.web.rest.util.HeaderUtil;
 ...
 */
@ControllerAdvice
@ConditionalOnProperty(prefix = "application", name = "exception-translator", havingValue = "custom", matchIfMissing = true)
